  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex-1 relative">
        ...
        <MainCard title="Solicitudes" tabs={solicitudesTabs} onTabChange={handleTabChange} activeTab="pendientes">
          <div className="relative p-6">
            ...
            <div className="flex justify-end mb-6">
              <div className="flex flex-col gap-3">
                <button 
                  ...
                  className="w-[138px] h-[34px] flex justify-center items-center bg-[#52DA96] text-white rounded-[30px]"
                >
                  Aprobar
                </button>
                <button 
                  onClick={handleDeny}
                  className="w-[153px] h-[33px] flex justify-center items-center bg-[#DA5F52] text-white rounded-[30px]"
                >
                  Reagendar
                </button>
              </div>
            ...
            <div className="flex flex-col gap-7 max-w-[600px] mx-auto">
              ...
              <div>
                ...
                <div className="h-[3px] bg-gray-200 w-[600px] mt-2"></div>
              </div>
              ...
              <div>
                ...
                <div className="h-[3px] bg-gray-200 w-full mt-2"></div>
              </div>
